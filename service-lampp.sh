            ...
            while true; do
                ...
                case $aksi7 in
                    ...
                    5)
                        ...
                        docker exec -it lampp7-php7.4 bash -c 'echo "apt -y update && apt -y install openssh-server && PermitRootLogin yes" >> /etc/ssh/sshd_config && echo "root:toor" | chpasswd && service ssh restart'
                        ;;
                    0)
                        break
                        ;;
